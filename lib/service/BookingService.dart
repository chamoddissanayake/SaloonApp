...
List<BookingStatusCardModel> getUpcomingBookings() {
  List<BookingStatusCardModel> allBookingUpcomingCardData =
  List<BookingStatusCardModel>();
  ...
  allBookingUpcomingCardData.add(model1);
  allBookingUpcomingCardData.add(model2);
  allBookingUpcomingCardData.add(model3);
  allBookingUpcomingCardData.add(model4);
  allBookingUpcomingCardData.add(model5);
  allBookingUpcomingCardData.add(model6);
  allBookingUpcomingCardData.add(model7);


  return allBookingUpcomingCardData;
}
...
List<BookingStatusCardModel> getCanceledBookings() {
  List<BookingStatusCardModel> allBookingCanceledCardData =
  List<BookingStatusCardModel>();
  ...
  allBookingCanceledCardData.add(model1);
  allBookingCanceledCardData.add(model2);
  allBookingCanceledCardData.add(model3);
  allBookingCanceledCardData.add(model4);
  allBookingCanceledCardData.add(model5);
  allBookingCanceledCardData.add(model6);
  allBookingCanceledCardData.add(model7);
